...
class InventoryPhysical(Base):
    __tablename__ = "inventory_physical"

    id:           Mapped[int]            = mapped_column(Integer, primary_key=True)
    id_fisico:    Mapped[int]            = mapped_column(Integer, nullable=False, index=True)
    ...
    cod_usuario:  Mapped[Optional[str]]  = mapped_column(String(100), nullable=True)
    hora:         Mapped[Optional[str]]  = mapped_column(String(50), nullable=True)
    observacion:  Mapped[Optional[str]]  = mapped_column(String(255), nullable=True)
    autorizada:   Mapped[int]            = mapped_column(SmallInteger, default=0)
