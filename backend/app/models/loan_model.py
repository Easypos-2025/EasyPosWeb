...
class Loan(Base):
    ...
    task_leader_id:           Mapped[Optional[int]] = mapped_column(ForeignKey("users.id"), nullable=True)
    external_collaborator_id: Mapped[Optional[int]] = mapped_column(ForeignKey("external_collaborators.id"), nullable=True)
    ...
    qr_signed_by:             Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
