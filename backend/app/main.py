...
async def _init_db_data():
    ...
    async with AsyncSessionLocal() as db:
        ...
        # ── Migración: has_parking en company_configs ─────────────────────────
        try:
            await db.execute(text(
                "ALTER TABLE company_configs ADD COLUMN IF NOT EXISTS has_parking INT NOT NULL DEFAULT 0"
            ))
            await db.commit()
        except Exception:
            await db.rollback()
        ...
        _pk_hijos = [
            ...
            ("/inventory/products",     "Productos Parking", "bi-box-seam-fill",     5),
        ]
        await db.flush()
        ...
        seed_sections = [
            ...
            },
            {
                ...
                "subtitle": "Comienza gratis y escala cuando lo necesites · También disponible en versión escritorio",
                "body_text": "",
                "cta_text": "",
                "cta_url": "",
                "image_url": "",
            ...
            {
                "section_key": "desktop",
                "title": "EasyPosWeb en tu PC · Versión de Escritorio",
                "subtitle": "Además de la plataforma web, EasyPosWeb cuenta con una aplicación de escritorio instalable. Sin navegador, sin dependencia de internet constante — acceso directo desde tu computador con toda la potencia del sistema.",
                "body_text": "Funciona sin internet (modo offline)|Instalación directa en Windows|Rendimiento nativo en tu equipo|Sincronización automática al recuperar conexión|Ideal para negocios con internet inestable|Misma interfaz que la versión web",
                "cta_text": "Solicitar versión escritorio",
                "cta_url": "",
                "image_url": "",
                "is_active": True,
                "order_index": 9,
            ...
            {
                "section_key": "desktop_plan_solo",
                "title": "Plan Escritorio",
                "subtitle": "Aplicación instalada directamente en tu PC. Opera sin internet, sincroniza cuando se conecta. Ideal para negocios con conectividad limitada o inestable.",
                "body_text": "Acceso sin internet (offline)|Instalación en Windows|Sincronización automática|Actualizaciones incluidas|Soporte técnico",
                "cta_text": "Consultar precio",
                "cta_url": "",
                "image_url": "",
                "is_active": True,
                "order_index": 10,
                "section_type": "plan_card",
            },
            {
                "section_key": "desktop_plan_mixed",
                "title": "Plan Mixto",
                "subtitle": "Lo mejor de ambos mundos: app de escritorio instalada en tu PC más acceso web completo desde cualquier dispositivo. Sincronización en tiempo real.",
                "body_text": "App escritorio + acceso web|Múltiples dispositivos simultáneos|Sincronización en tiempo real|Opera offline y en línea|Soporte prioritario",
                "cta_text": "Consultar precio",
                "cta_url": "",
                "image_url": "",
                "is_active": True,
            ...
            },
            {
                ...
                "subtitle": "Múltiples métodos de pago disponibles próximamente",
                "body_text": "",
                "cta_text": "",
                "cta_url": "",
                "image_url": "",
            ...
            },
            {
                ...
                "subtitle": "Llega a miles de emprendedores y empresarios. Completa el formulario y te contactamos.",
                "body_text": "",
                "cta_text": "",
                "cta_url": "",
                "image_url": "",
            ...
            {
                "section_key": "free_plan_note",
                "title": "Sin tarjeta de crédito · Sin contrato · Empieza en minutos",
                "subtitle": "",
                "body_text": "",
                "cta_text": "",
                "cta_url": "",
            ...
            },
            {
                ...
                "title": "Datos de contacto (email, sitio web, tiempo de respuesta)",
                "subtitle": "Los 3 valores separados por | en 'Contenido', en este orden. Los iconos son fijos.",
                "body_text": "easypos.co@gmail.com|easyposweb.com|Respuesta en menos de 24 horas",
                "cta_text": "",
                "cta_url": "",
                "image_url": "",
                "is_active": True,
