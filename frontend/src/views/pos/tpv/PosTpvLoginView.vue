...
.waiter-btn:hover { border-color: #2563eb; background: #eff6ff; }
.waiter-btn--active { border-color: #2563eb; background: #dbeafe; color: #1d4ed8; }
.waiter-btn__icon { font-size: 1.8rem; }
.waiter-btn__name { text-align: center; line-height: 1.2; word-break: break-word; }

.company-input { text-align: left; margin-bottom: 20px; }
...
.pin-key:active { transform: scale(.93); background: #e2e8f0; }
.pin-key--empty { border: none; background: transparent; cursor: default; }
.pin-key--del { color: #ef4444; border-color: #fecaca; background: #fff5f5; }

.login-error { color: #ef4444; font-size: .875rem; font-weight: 500; }
...
@media (max-width: 576px) {
  .login-page { align-items: flex-start; padding-top: 32px; }
